...
exports.list = (req, res) => {
    let order = req.query.order ? req.query.order : 'ascending'
...
// It will find products based on request category
...
exports.searchedProduct = (req, res) => {
